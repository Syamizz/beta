                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                ...
                                <li><a class="dropdown-item" href="{{ route('maklumatLaporan') }}">Laporan Keahlian</a>
                                </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item dropdown-toggle" href="#">Pentadbiran Akaun</a>
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="{{ route('pelayarAkaun') }}">Pelayar
                                                Akaun</a></li>
                                    </ul>
                                </li>
        ...
        <div class="col-md-10">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <table id="table" border="1">
                                ...
                                @foreach ($akaun as $info)
                                    <tr>
                                        <td>{{ $info->akaun_desc }} ({{ $info->akaun_no }}) </td>
                                    </tr>
                                @endforeach
                            </table>
                        </div>
                    ...
                    <br>
                    <a class="btn btn-secondary" onclick="infoAkaun()">Select</a>
    ...
    <script>
        ...
        for (var i = 1; i < table.rows.length; i++) {
            table.rows[i].onclick = function() {
                ...
                var noAcc = this.cells[0].innerHTML;
                reverseAcc = reverseString(noAcc);
                reverseAcc2 = reverseAcc.substring(2, 10);
